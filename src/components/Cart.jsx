  ...
  return (
    <div className="w-full px-4 bg-white py-[10rem]">
      <div className="max-w-[1240px] mx-auto flex flex-col md:flex-row gap-[1.2rem]">
        <div className="w-full shadow-xl flex-col py-8 my-8 rounded-lg  hover:scale-105 duration-300 mx-auto">
          <img
        ...
        <div className="w-full shadow-xl flex-col py-8 my-8 rounded-lg  hover:scale-105 duration-300 ">
          <img
            className="w-20 mx-auto mt-[-3rem] bg-white"
            src={Invest}
            alt="/"
          ...
          <button className="bg-black text-[#00df9a] rounded-md cursor-pointer py-3  font-medium w-[200px]  mx-auto my-6 hover:text-white hover:bg-green-600 ease-out duration-500 ">
            Start Trial
          </button>
        </div>
